        ...
        <div class="row mt-4">
            ...
            <div class="col-md-9">
                ...
                <div class="card card-profil p-4">
                    <h5 class="fw-bold mb-4 text-velvet">EDIT PROFILE</h5>
                    
                    <form action="proses_edit_profil.php" method="POST" enctype="multipart/form-data">
                        
                        <div class="mb-4 text-center">
                            <?php
                            $fotoPath = "assets/foto/" . (isset($_SESSION['foto']) ? $_SESSION['foto'] : '');
                ...
                <div class="card card-profil p-4">
                    <h5 class="fw-bold mb-3 text-velvet">ACCOUNT INFO</h5>
                ...
                <div class="card card-profil p-4">
                    <h5 class="fw-bold mb-3 text-velvet">CHANGE PASSWORD</h5>
